...
let imageInputText = imageFilename =>
  imageFilename->(
                   Belt.Option.getWithDefault(
                     t("certificate_base_image.placeholder"),
                   )
                 );
let selectFile = (send, event) => {
  let files = React.Event.Form.target(event)##files;
              ...
              <div className="max-w-2xl pb-6 mx-auto">
                <div className="mt-5">
                  ...
                  <input
                    ...
                    onChange={event =>
                      send(
                        UpdateName(React.Event.Form.target(event)##value),
                      )
                    }
                  />
                </div>
                <div className="mt-5">
                  <div>
                    ...
                    <HelpIcon
                      className="ml-2"
                      link={t("certificate_base_image.help_url")}>

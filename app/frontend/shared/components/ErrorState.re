[@mel.module "../images/page-not-found.svg"]
...
let make =
  ...
  <div
    className="flex flex-1 w-full h-full bg-gray-100 items-center justify-center">
    <div
      className="flex flex-col items-center max-w-3xl mx-auto text-center px-4 pb-4">

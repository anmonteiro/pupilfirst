...
let qrVisiblityClasses = (qrCorner, visible) => {
  ...
  let baseClasses = "toggle-button__button";
  let additionalClasses =
    if (selected) {" toggle-button__button--active"} else {""};
  baseClasses ++ additionalClasses;
};
...
let saveChanges = (certificate, updateCertificateCB, state, send, _event) => {
  ...
  switch (state) {
  | {margin, nameOffsetTop, fontSize, qrCorner, qrScale, active, _} =>
  ...
  <SchoolAdmin__EditorDrawer
    ...
    <div className="flex flex-col min-h-screen">
      <DisablingCover
        ...
        containerClasses="bg-white grow-0">
        ...
        <div className="max-w-4xl px-4 py-6 mx-auto">
          ...
          <div className="mt-4">
            ...
            <div>
              <input
                ...
                onChange={event =>
                  send(UpdateName(React.Event.Form.target(event)##value))
                }
                value={state.name}
              />
          ...
          <div className="mt-6" ariaLabel="auto_issue">
            ...
            <HelpIcon className="ml-1" link={t("active.help_url")}>
              <span
                dangerouslySetInnerHTML=[%obj {__html: t("active.help")}]
              />
            </HelpIcon>
          ...
          <div className="flex mt-4">
            ...
            <div className="w-2/5 pl-5">
              <div>
                ...
                <input
                  ...
                  onChange={event =>
                    send(
                      UpdateMargin(
                        React.Event.Form.target(event)##value->int_of_string,
                      ),
                    )
                  }
                />
              ...
              <div className="mt-4" ariaLabel="add_qr_code">
                ...
                <div
                  className="ml-4 inline-flex toggle-button__group shrink-0">
                  <button
                 ...
                 [|
                   <div className="mt-4" key="position">
                     ...
                     <div className="flex mt-2">
                       <button
                         className={
                           "w-1/2 mr-2 rounded border pt-3 px-3 pb-5 text-sm font-semibold hover:bg-gray-300 hover:text-gray-900 focus:outline-none focus:bg-gray-300 focus:text-gray-900 focus:ring-2 focus:ring-focusColor-500 "
                       ...
                       <button
                         className={
                           "w-1/2 rounded border pt-3 px-3 pb-5 text-sm font-semibold hover:bg-gray-300 hover:text-gray-900 focus:outline-none focus:bg-gray-300 focus:text-gray-900 focus:ring-2 focus:ring-focusColor-500 "
                     ...
                     <div className="flex mt-2">
                       <button
                         className={
                           "w-1/2 mr-2 rounded border pt-5 px-3 pb-3 text-sm font-semibold hover:bg-gray-300 hover:text-gray-900 focus:outline-none focus:bg-gray-300 focus:text-gray-900 focus:ring-2 focus:ring-focusColor-500 "
                       ...
                       <button
                         className={
                           "w-1/2 rounded border pt-5 px-3 pb-3 text-sm font-semibold hover:bg-gray-300 hover:text-gray-900 focus:outline-none focus:bg-gray-300 focus:text-gray-900 focus:ring-2 focus:ring-focusColor-500 "
        ...
        <div className="max-w-4xl px-4 py-6 mx-auto">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              {if (issuedCount > 0 && !saveButtonDisabled) {
                 <div

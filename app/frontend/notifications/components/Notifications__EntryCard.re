[%%raw {js|import "./Notifications__EntryCard.css"|js}];
...
let make = (~entry, ~markNotificationCB) => {
  ...
  <div
    className={
      "notifications__entry-card block relative py-5 px-4 lg:px-8 text-sm font-medium hover:bg-gray-50 focus-within:bg-gray-50 transition ease-in-out duration-150 "
      ++ (
    ...
    <div className="flex justify-between items-center">
      <div className="flex-1 flex items-center relative">
        ...
        {if (Entry.notifiableId(entry)->Belt.Option.isSome) {
           <a

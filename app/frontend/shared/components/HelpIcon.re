...
let make =
  ...
  <div
    ...
    <FaIcon
      classes="fas fa-question-circle hover:text-gray-600 cursor-pointer"
    />
    {if (helpVisible) {
       <div
         onClick={event => event |> React.Event.Mouse.stopPropagation}
         className={
           "help-icon__help-container overflow-y-auto mt-1 border border-gray-900 absolute z-50 px-4 py-3 shadow-lg leading-snug rounded-lg bg-gray-900 text-white max-w-xs"

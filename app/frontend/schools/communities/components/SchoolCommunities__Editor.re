...
let handleQuery =
  ...
  | {name, targetLinkable, _} =>
    ...
    if (name != "") {
      ...
      | Some(community) =>
        ...
        |> Js.Promise.then_((response: UpdateCommunityQuery.t) => {
             ...
             Notification.success(
               ...
               t("community_updated_notification"),
             );
             Js.Promise.resolve();
           })
        |> ignore
      | None =>
        CreateCommunityQuery.fetch({name, targetLinkable, courseIds})
      ...
      Notification.error(
        ts("notifications.empty"),
        t("notification_answer_cant_blank"),
      );
    };
  };
};
      ...
      <div key="communities-editor" className="mt-3">
        <div className="mt-2">
          ...
          <input
            ...
            value={state.name}
            onChange={event => {
              let name = React.Event.Form.target(event)##value;
        ...
        <div className="flex items-center mt-6">
          ...
          <div
            className="flex toggle-button__group flex-no-shrink overflow-hidden ml-2">
            <button
        ...
        <div className="mt-4 px-6 py-2 bg-gray-50 border rounded">
          ...
          {switch (community) {
           | Some(_community) =>
             if (categories |> ArrayUtils.isEmpty) {
